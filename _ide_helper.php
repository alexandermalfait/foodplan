...
class Doctrine extends Atrauzzi\LaravelDoctrine\Support\Facades\Doctrine{
	/**
	 * {@inheritDoc}
	 *
	 * @static 
	 ...
	 */
	 public static function getExpressionBuilder(){
		 Doctrine\ORM\EntityManager::getExpressionBuilder();
	 }
	 ...
	 */
	 public static function beginTransaction(){
		 Doctrine\ORM\EntityManager::beginTransaction();
	 }
	 ...
	 */
	 public static function getCache(){
		 Doctrine\ORM\EntityManager::getCache();
	 }
	 ...
	 */
	 public static function transactional($func){
		 Doctrine\ORM\EntityManager::transactional($func);
	 }
	 ...
	 */
	 public static function commit(){
		 Doctrine\ORM\EntityManager::commit();
	 }
	 ...
	 */
	 public static function rollback(){
		 Doctrine\ORM\EntityManager::rollback();
	 }
	 ...
	 */
	 public static function createNamedQuery($name){
		 Doctrine\ORM\EntityManager::createNamedQuery($name);
	 }
	 ...
	 */
	 public static function createNativeQuery($sql, $rsm){
		 Doctrine\ORM\EntityManager::createNativeQuery($sql, $rsm);
	 }
	 ...
	 */
	 public static function createNamedNativeQuery($name){
		 Doctrine\ORM\EntityManager::createNamedNativeQuery($name);
	 }
	 ...
	 * @static 
	 */
	 public static function find($entityName, $id, $lockMode = 0, $lockVersion = null){
	 ...
	 */
	 public static function getReference($entityName, $id){
		 Doctrine\ORM\EntityManager::getReference($entityName, $id);
	 }
	 ...
	 */
	 public static function getPartialReference($entityName, $identifier){
		 Doctrine\ORM\EntityManager::getPartialReference($entityName, $identifier);
	 }
	 ...
	 */
	 public static function close(){
		 Doctrine\ORM\EntityManager::close();
	 }
	 ...
	 */
	 public static function copy($entity, $deep = false){
		 Doctrine\ORM\EntityManager::copy($entity, $deep);
	 }
	 ...
	 */
	 public static function lock($entity, $lockMode, $lockVersion = null){
		 Doctrine\ORM\EntityManager::lock($entity, $lockMode, $lockVersion);
	 }
	 ...
	 */
	 public static function isOpen(){
		 Doctrine\ORM\EntityManager::isOpen();
	 }
	 ...
	 */
	 public static function getHydrator($hydrationMode){
		 Doctrine\ORM\EntityManager::getHydrator($hydrationMode);
	 }
	 ...
	 */
	 public static function getProxyFactory(){
		 Doctrine\ORM\EntityManager::getProxyFactory();
	 }
	 ...
	 */
	 public static function initializeObject($obj){
		 Doctrine\ORM\EntityManager::initializeObject($obj);
	 }
	 ...
	 */
	 public static function isFiltersStateClean(){
		 Doctrine\ORM\EntityManager::isFiltersStateClean();
	 }
	 ...
	 */
	 public static function hasFilters(){
		 Doctrine\ORM\EntityManager::hasFilters();
	 }
